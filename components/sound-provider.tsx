...
export function SoundProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    function handleClick(e: MouseEvent) {
      ...
      if (target.closest("button, [role='button'], a, label:has(input[type='checkbox']), input[type='checkbox'], [data-slot='dropdown-menu-item'], [data-slot='dropdown-menu-checkbox-item'], [data-slot='dropdown-menu-radio-item']")) {
        const h = getHowl();
